		...
		<div class="row merged">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="land-featurearea">
					<div class="land-meta">
						<h1 style="font-family: 'Playfair Display', sans-serif;
									  background: -webkit-linear-gradient(#0C134F, #5C469C);
						...
						<p style="
								...
								"
						>
							 Igniting the Joy of Book Sharing
						</p>
						<div class="friend-logo">
							<span><img src="<?php echo base_url(''); ?>assets/images/favicon.svg" alt=""></span>
						</div>
					</div>	
				</div>
			</div>
				...
				<div class="login-reg-bg">
					<div class="log-reg-area sign">
						<h2 class="log-title">Login</h2>
							...
							<div class="form-group">	
							  <input type="text" name="username" id="input" required="required"/>
							...
							<div class="checkbox">
							  <label>
								<input type="checkbox" name="remember" value="yes"/><i class="check-box"></i>Always Remember Me.
							  </label>
							</div>
					...
					<div class="log-reg-area reg">
						<h2 class="log-title">Register</h2>
							...
							<div class="submit-btns">
								<span><input class="mtr-btn signup" style="text-decoration: none; color:white;" type="submit" value="Register"></span>
							</div>
						 	<?php echo form_close(); ?>
					</div>
				</div>
